 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `CRModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
 @code
     @interface CRAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation CRAuthor
     @end
 
     @interface CRBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) CRAuthor *author;
     @end
     @implementation CRBook
     @end
    
     int main() {
         // create model from json
         CRBook *book = [CRBook CR_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book CR_modelToJSONString];
 ...
 @code
     @interface CRShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation CRShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self CR_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self CR_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self CR_modelCopy]; }
     - (NSUInteger)hash { return [self CR_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self CR_modelIsEqual:object]; }
     @end
 @endcode
 
 */
@interface NSObject (CRModel)
 ...
 */
+ (nullable instancetype)CR_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> NSDate, parsed with format "CRCR-MM-dd'T'HH:mm:ssZ", "CRCR-MM-dd HH:mm:ss" or "CRCR-MM-dd".
     `NSString` -> NSURL.
     `NSValue` -> struct or union, such as CGRect, CGSize, ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)CR_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)CR_modelToJSONObject;
 ...
 */
- (nullable NSData *)CR_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)CR_modelToJSONString;
 ...
 */
+ (nullable NSArray *)CR_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (CRModel)
 ...
 */
+ (nullable NSDictionary *)CR_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<CRModel>' to your class header.
 */
@protocol CRModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class CRShadow, CRBorder, CRAttachment;
        ...
        @implementation CRAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [CRShadow class],
                     @"borders" : CRBorder.class,
...
/**
 ...
 Example:
 @code
        @class CRCircle, CRRectangle, CRLine;
 
        @implementation CRShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [CRCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [CRRectangle class];
