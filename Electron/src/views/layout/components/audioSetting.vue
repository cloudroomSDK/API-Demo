    ...
    methods: {
        ...
        init() {
            ...
            if (micList.length) {
                ...
                this.micSel = audioCfg._micID || "default";
            }
            ...
            if (speakerList.length) {
                ...
                this.speakerSel = audioCfg._spkID || "default";
            }
        },
        // 通知有音频设备变化
